/*
 ...
 - Descripcion del programa:
    Este programa le muestra al usuario la linea exterior de una piramide formada por letras Z, desde el inicio
 */
 function imagenPiramideZ() {
    ...
    for (let fila = 1; fila <= filas; fila++) {
        ...
        for (let columna = 1; columna <= columnas; columna++) {
            if (columna === filas - fila + 1 || columna === columnas - filas + fila -1) {
                output += `${letra}`;
            } else {
                output += ' ';
            }
